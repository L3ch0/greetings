  ...
  gifts: [
    {
      ...
      content: 'Пам\'ятаєш, як ми вперше зустрілися? Той день змінив все. Твоя усмішка й очі зачарували з першого погляду. Це був найкращий день у моєму житті.',
    },
    {
      type: 'compliment',
    ...
    },
    {
      ...
      caption: 'Цей день залишиться в моєму серці назавжди',
    },
    {
      type: 'voice',
